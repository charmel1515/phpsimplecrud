...
class Peserta extends Database {
    ...
    public function inputPeserta($data){
        ...
        $query = "INSERT INTO tb_peserta ( nip_peserta, nama_peserta, jurusan_peserta, kelas, email,telp, lomba_diikuti) VALUES ( ?, ?, ?, ?, ?, ?, ? )";
    ...
    public function searchPeserta($kataKunci){
        ...
        $query = "SELECT id_peserta, nip_peserta, nama_peserta, jurusan_peserta, kelas, email, no_telepon, lomba_diikuti,tb_jenislomba.nmlomba, tb_jurusan.nama_jurusan, tb_kelas.nama_kelas, email, telp, lomba
                  FROM tb_peserta
                  JOIN tb_jenislomba ON tb_peserta.nmlomba = id_jenislomba
                   JOIN tb_jurusan ON tb_peserta.nama_jurusan = kode_jurusan
                  JOIN tb_kelas ON tb_peserta.nama_kelas = id_kelas
