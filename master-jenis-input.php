...
if(isset($_GET['status'])){
    if($_GET['status'] == 'failed'){
        echo "<script>alert('Gagal menambahkan jenis lomba. Silakan coba lagi.');</script>";
    }
}
			...
			<main class="app-main">
				...
				<div class="app-content-header">
					<div class="container-fluid">
						<div class="row">
							<div class="col-sm-6">
								<h3 class="mb-0">Input Jenis Lomba</h3>
							</div>
							<div class="col-sm-6">
								<ol class="breadcrumb float-sm-end">
									<li class="breadcrumb-item"><a href="index.php">Beranda</a></li>
									<li class="breadcrumb-item active" aria-current="page">Input Jenis</li>
								</ol>
							</div>
						</div>
					</div>
							...
							<div class="col-12">
								<div class="card">
                                    ...
                                    <form action="proses/proses-prodi.php?aksi=inputprodi" method="POST">
									    <div class="card-body">
                                            <div class="mb-3">
                                                <label for="nama" class="form-label">id jenis lomba</label>
                                                <input type="text" class="form-control" id="id_jenislomba" name="id_jenislomba" placeholder="Masukkan id jenis lomba" required>
                                            </div>
											<div class="mb-3">
												<label for="nama" class="form-label">Nama Lomba</label>
												<input type="text" class="form-control" id="nm_lomba" name="nm_lomba" placeholder="Masukkan nama jenis lomba" required>
											</div>
                                        </div>
