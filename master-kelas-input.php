...
if(isset($_GET['status'])){
    if($_GET['status'] == 'failed'){
        echo "<script>alert('Gagal menambahkan data Kelas. Silakan coba lagi.');</script>";
    }
}
						...
						<div class="row">
							<div class="col-12">
								<div class="card">
                                    ...
                                    <form action="proses/proses-kelas.php?aksi=inputkelas" method="POST">
									    <div class="card-body">
											<div class="mb-3">
